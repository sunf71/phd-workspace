function descriptor_points=Do_Sift_Dorko_color(im,descriptor_name,image_dir,points_detect,siftscone)
% siftscone=1;
im=imread(im);
im=im2double(im);
[O1,O2,O3]=RGB2O(im);
...
%     delete('/media/DATA/Datasets/Texture_own/Temp/points.txt')
    ...
    points_load2=load_vector('/media/DATA/Datasets/Texture_own/Temp/points1.txt');
...
%      delete('/media/DATA/Datasets/Texture_own/Temp/points.txt')
     ...
     system(command6);
    %%%%%%%%%%%%%%%%% Read The points from Points.txt for channal O2 %%%%%%%%%%%%%
    points_load3=load_vector('/media/DATA/Datasets/Texture_own/Temp/points2.txt');
