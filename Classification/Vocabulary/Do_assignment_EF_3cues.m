function []=Do_assignment_EF_3cues(opts,assignment_opts)  %%%%%%%%%%%%% Only for Early Fusion case
...
for i=1:nimages
      ...
      if(strcmp(assignment_opts.type,'hard'))
          ...
          for jj=1:length(assignment_opts.EF_alpha)
            points_total=[(assignment_opts.EF_alpha(jj))*points,assignment_opts.EF_alpha2(jj)*points2,assignment_opts.EF_alpha3(jj)*points3];
...
display('3 Cues EF Assignment Done');
pause
