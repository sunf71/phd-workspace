function []=Do_assignment_Det_main(opts,assignment_opts)
...
try
    ...
    if(isequal(assignment_opts,assignment_opts2))
       ...
       if(strcmp(assignment_opts.det_method,'SW'))

           
            %%%%%%%%% Compute the Spatial Pyramids Assignment %%%%%%%%%%%
%             All_hist=Do_assignment_pyramids_lazebnik_normal(opts,assignment_opts);

             Do_assignment_DetSW(opts,assignment_opts);
            
       elseif(strcmp(assignment_opts.det_method,'ESS'))
           
           %%%%%%%%% Compute the Spatial Pyramids Assignment %%%%%%%%%%%
            Do_assignment_DetESS(opts,assignment_opts);
