function []=Do_assignment_par_noha(opts,assignment_opts)
...
% load('/home/fahad/Datasets/Pascal_2007/VOCdevkit/VOC2007/Data/Global/Vocabulary/fastkmeansSIFT_DorkoHarrLap6000.mat');
...
jb = createJob(jm, 'PathDependencies', {'/home/fahad/Matlab_code', ...
     ...
     '/home/fahad/Matlab_code/sparse_coding:', ...
     '/home/fahad/Matlab_code/sparse_coding/ScSPM:', ...
     '/home/fahad/Matlab_code/sparse_coding/ScSPM/sparse_coding:', ...
});
%[all_hist,index_list]=do_assign_range_normal_noha(opts,assignment_opts,1, 10,voc)
numTasks = 8;
%                       nimages=50;
tasksPerJob = floor(nimages / numTasks);
for i = 1:tasksPerJob:nimages
     createTask(jb, @do_assign_range_normal_noha, 2, {opts, assignment_opts, i, min(nimages, i+tasksPerJob-1),voc});
%       createTask(jb, @do_assign_range_sparse, 2, {opts, assignment_opts, i, min(nimages, i+tasksPerJob-1),voc});
end
