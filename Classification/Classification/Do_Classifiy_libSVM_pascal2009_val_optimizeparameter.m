function ap=Do_Classifiy_libSVM_pascal2009_val_optimizeparameter(opts,classification_opts,rng,c,weights)
...
% 
%      histogram=[weights(1).*histogram1;weights(2).*histogram2;weights(2).*histogram3;weights(3).*histogram4;weights(3).*histogram5;weights(3).*histogram6;weights(3).*histogram7;weights(4).*histogram8];
histogram=[weights(1).*histogram1;weights(2).*histogram2;weights(2).*histogram3;weights(3).*histogram6;weights(4).*histogram8];
