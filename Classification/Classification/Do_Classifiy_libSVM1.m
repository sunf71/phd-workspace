function [svm_score,best_CV]=Do_Classifiy_libSVM1(opts,classification_opts)
...
%                   [best_C,best_G,best_CV]=Do_libSVM_chi(histogram_train',histogram_test',train_truth,test_truth,best_C,best_G); 
       case 2   
