function [ap]=Do_Classifiy_libSVM_pascal2009_val_optimizeparameter_main(opts,classification_opts,rng,c)

weights_step=0.05;

weights=[0.25 0.25 0.25 0.25];   % some start values
max_score=0;
...
while(change_flag)  
    ...
    for ii=1:(length(weights))
        ...
        if(weightsT(ii)+weights_step<1)
            ...
            %%%%%%%replaced with my function %%%%%%%
         new_score=Do_Classifiy_libSVM_pascal2009_val_optimizeparameter(opts,classification_opts,rng,c,weightsT);
