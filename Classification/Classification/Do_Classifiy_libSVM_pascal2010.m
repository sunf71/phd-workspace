function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2010(opts,classification_opts,rng)
...
% clear histogram1 histogram2 histogram3 histogram4 histogram5 
size(histogram)
