...
%       histogram=[(0.6).*histogram1;(0.4).*histogram2];%%%% scenes weighting
         histogram=[(0.7).*histogram1;(0.3).*histogram2;(0.3).*histogram3];
%%%% This one 
...
%  histogram=[(0.85).*histogram1;(0.05).*histogram2;(0.1).*histogram3];
...
%           save -v7.3 '/home/fahad/Datasets/flower/Data/Global/predict_labels_HUE' predict_labels
%           save -v7.3 '/home/fahad/Datasets/flower/Data/Global/dec_values_HUE' dec_values
       case 2   
