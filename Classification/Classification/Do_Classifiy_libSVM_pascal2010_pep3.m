function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2010_pep3(opts,classification_opts,rng)
...
%             fclose(fid);
%             display('class done');
%% in case of only my test set for VOC2010 image classification submission           
            %%%%% save the probabilities with the class name to the results folder 
            fid=fopen(sprintf(opts.clsrespath,cls),'w');
            imgset='test';
