function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2007_multiplehistogram(opts,classification_opts,rng)
...
%           histogram=[(0.1).*histogram1;(0.35).*histogram2;(0.05).*histogram3;(0.3).*histogram4;(0.2).*histogram5];
              histogram=[histogram1;histogram2;histogram3;histogram4;histogram5;histogram6;histogram7];
for i=rng
    cls=opts.classes{i};
