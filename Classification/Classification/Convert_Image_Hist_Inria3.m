function All_hist=Convert_Image_Hist_Inria3(opts,assignment_opts,index_im,im,patch_step,image_dir)
index=index_im(:,3);
points=index_im(:,1:2);
[H W dim]=size(im);
% window parameter
...
a1=1:patch_length;
 All_hist1=zeros(10500,length(a1));
...
a2=patch_length+1:patch_length*2;
 All_hist2=zeros(10500,length(a2));
...
a3=(patch_length*2)+1:patch_length*3;
 All_hist3=zeros(10500,length(a3));
...
a4=(patch_length*3)+1:patch_length*4;
 All_hist4=zeros(10500,length(a4));
...
a5=(patch_length*4)+1:patch_length*5;
 All_hist5=zeros(10500,length(a5));
...
%% 6th part of patch
 ...
 All_hist6=zeros(10500,length(a6));
