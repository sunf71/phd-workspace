function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2008_val(opts,classification_opts)
...
if ~isfield(classification_opts,'num_train_images');      classification_opts.num_train_images='Unknown';                 end
 ...
 labels=[];
  %%%%%%%%%%%%%%%% To check on the valuidation set , add these additonal lines 
   labels_train=zeros(2111,20); %%%% Pascal 2007 have total 9963 images across 20 classes
...
labels_test=zeros(2221,20); %%%% Pascal 2007 have total 9963 images across 20 classes
imgset='val'; %%%% for training images
    ...
    trainset=zeros(4332,1);
    testset=zeros(4332,1);
