...
globalparam = struct();
globalparam.prefix  = '/home/amounir/Workspace/Superpixels-iccv2009/results/RAD_Parallelized_1' ;
globalparam.crf = 1;
...
for n = 1:length(neighbors)
  ...
  param.db_path = '/home/amounir/Workspace/Superpixels-iccv2009/VOCdevkit';
  param.db_tag  = 'p07';
  param.fg_cat  = '';
  param.testall = 1;
