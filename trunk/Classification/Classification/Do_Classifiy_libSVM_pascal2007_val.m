function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2007_val(opts,classification_opts,rng)
...
%  test_truth=test_truth(testset>0,:);
 ...
 %%%%%%%%%%%%% Do Classification %%%%%%%%%%%%%
            ...
            %%%%%%% Cross Validation %%%%%%%%
%            [best_C,best_CV]=Do_CV_libSVM_chisq(histogram_train',train_truth);
