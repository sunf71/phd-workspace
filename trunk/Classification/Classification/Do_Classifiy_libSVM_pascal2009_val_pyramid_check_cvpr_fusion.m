function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2009_val_pyramid_check_cvpr_fusion(opts,classification_opts,rng)
...
%      histogram_sift=[histogram1;histogram2;histogram3];
...
%      histogram=[(0.8).*histogram_sift;(0.2).*histogram_color];
