function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2010_val12(opts,classification_opts,rng)
...
%  load(opts.testset)
 ...
 labels=[];
  %%%%%%%%%%%%%%%% To check on the valuidation set , add these additonal lines 
   labels_train=zeros(4998,20); %%%% Pascal 2007 have total 9963 images across 20 classes
...
labels_test=zeros(5105,20); %%%% Pascal 2007 have total 9963 images across 20 classes
imgset='val'; %%%% for training images
 ...
 %%%%%%%%%%%% Load the Histograms %%%%%%%%%%%%%
 histogram=getfield(load([opts.data_globalpath,'/',classification_opts.assignment_name]),'All_hist');
