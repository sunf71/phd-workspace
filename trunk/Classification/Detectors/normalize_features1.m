function [patches]=normalize_features1(im,points,patch_size,scale_magnif)
...
%         patch = normalize_patch3(im, x, y, 1, 0, 1, 0, s, patch_size); 
        %patch = normalize_patch(im, x, y, 1, 0, 1, 0, s, patch_size); 
