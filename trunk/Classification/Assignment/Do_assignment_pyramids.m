function []=do_assignmentv4(opts,assignment_opts,descriptor_opts)
...
save ([opts.data_globalpath ,'/',assignment_opts.name],'All_hist');                               % save the BOW representation in opts.globaldatapath
save ([opts.data_globalpath ,'/',assignment_opts.name,'_settings'],'assignment_opts');