function [all_hist,index_list]=do_assign_range_sparse(opts,assignment_opts,start_images, end_images,voc)
...
for i=start_images:end_images
    ...
    %%%%%%%%%%% collect the different detected points %%%%
     ...
     %%%%%% making a structure similar to the example code %%%%%
      ...
      all_hist(:,i - start_images + 1) = ScSPM(feature_struct,voc', gamma, pyramid, weights, pooling);
...
%         
%        assignments=[det_points_final,index]; 
