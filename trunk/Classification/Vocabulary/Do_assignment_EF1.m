function []=Do_assignment_EF1(opts,assignment_opts)  %%%%%%%%%%%%% Only for Early Fusion case
...
for jj=1:length(assignment_opts.EF_alpha)
    ...
    save ([opts.data_assignmentpath,'/',assignment_opts.name1,'_hybrid_index'],'index_list');
    display('computed');
    pause
