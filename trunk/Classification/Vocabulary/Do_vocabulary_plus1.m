function []=Do_vocabulary_plus1(opts,vocabulary_opts)
%%%%%%%%%% to combine points from david's 4 detectors and dense grid %%%%%%%%%%%%
if nargin<2
    vocabulary_opts=[];
end
...
% counter
%           points=[];
%         %%%%%%%%%%%%% if using 5 detectors %%%%%%%%%%%%%
%           %%%%%%%%%%%%%%%% Detector 1 is Grid_dense %%%%%%%%%%%%%%%%%%%%%%%
          points_out=load([data_locations{i},'/',vocabulary_opts.descriptor_name]);
          points_det1 = getfield(points_out,'descriptor_points'); 
          sample_step_det1=ceil(size(points_det1,1)/vocabulary_opts.sample_rate_grid);
          points_sample_det1=points_det1(1:sample_step_det1:size(points_det1,1),:);
          
          %%%%% detector 2 HarLapv1_MS  %%%%
...
%           %%%%% detector 3 BoostHarLapv1_MS  %%%%
          ...
          sample_step_det3=ceil(size(points_det3,1)/vocabulary_opts.sample_rate);
...
% %           %%%%%%%%%%% combine all 3 together %%%%%%%%%%
         points=[points_sample_det1;points_sample_det2;points_sample_det3;points_sample_det4;points_sample_det5];
%               points=[points_sample_det1;points_sample_det2;points_sample_det3];
...
%           points_sample_det5=points_det5(1:sample_step_det5:size(points_det5,1),:);
          ...
          points2=[points_sample_det1;points_sample_det2;points_sample_det3;points_sample_det4;points_sample_det5];
...
%             [voc,A] = vl_ikmeans(points_total1',13000,'method', 'elkan');
%             save ([opts.data_vocabularypath,'/',vocabulary_opts.name],'voc');
%             save ([opts.data_vocabularypath,'/',vocabulary_opts.name,'_settings'],'vocabulary_opts');
%             display('done');
%             pause
