function descriptor_points=Do_Sift_Dorko_color1(im,descriptor_name,image_dir,points_detect,siftscone)
% siftscone=1;
im=imread(im);
im=im2double(im);
[O1,O2,O3]=RGB2O(im);
...
save_points('/media/DATA/Datasets/Texture_own/Temp/detector_points.txt',points_detect);
