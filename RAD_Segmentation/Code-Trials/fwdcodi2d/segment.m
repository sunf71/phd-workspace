...
% Real images dataset
% [filesearchdir, junk1, junk2, junk3] = fileparts('Y:\Datasets\Color constancy\Barnard\mondrian_8_bit\ball\');

% Video deer lake
[filesearchdir, junk1, junk2, junk3] = fileparts('Y:\Datasets\Color constancy\Ciurea_Funt\DB4501\Deer_Lake\');
...
%             zonesInf;
            ...
            %% Show the colors surface distribution
            disSmooth(disSmooth==0)=NaN;
            fig = figure(4);
            surf(flipud(double(disSmooth)),'edgecolor','none')
            set(fig, 'Name', 'Surface Distribution', 'NumberTitle','off');
